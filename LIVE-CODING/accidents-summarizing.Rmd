...
The variable `addr_type` describes the location of the accident. Where do most accidents occur?  Create a frequency table of `addr_type`. (see slide 10 from the slidedeck posted for 10/16)
...
Write code to create a frequency table of each variable to examine their distributions. Go ahead and write code to do this.
...
Write code to create a contingency table of the frequencies for `light_cat` and `hit_parked_car`. If there is no association between these variables, what % of cars should be hit regardless of light conditions?   (see slide 14 from the slidedeck posted for 10/16)


### Exercise 4

Fill in the blanks in the code below to make a segmented bar plot to visualize the contingency table from exercise 3.
...
Write code to draw a mosaicplot to visualize the strength of the associations seen in the contingency table. Write a couple of sentences to describe what you learn.
