...
Write code to create a contingency table of the frequencies for `light_cat` and `hit_parked_car`. If there is no association between these variables, what % of cars should be hit regardless of light conditions?
