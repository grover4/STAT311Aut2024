...
- Very preliminary exploratory data analysis, such as some summary statistics and visualizations of some key variables, along with an explanation on how they help you learn more about your data. **Suggested division of labor: each member of the group is responsible for creating at least one visualization and calculating summaries statistics for at least one variable.** 
...
<!--- Delete this section if not used. You may use the MLA or ALP format for listing references, just be consistent.  --->